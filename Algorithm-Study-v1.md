...
> 이 문서는 종료된 **Algorithm-Study v1**의 진행 방식 및 풀이 기록 아카이브입니다.
> 현재 진행 중인 스터디는 [README](./README.md)를 참고하세요.
...
|        | 4/9   |                             | 37. [쿼드압축 후 개수 세기](https://school.programmers.co.kr/learn/courses/30/lessons/68936?language=java) | ☑️   |
|        |       |                             | 38. [스타트링크](https://www.acmicpc.net/problem/5014)                                                     | ☑️   |
